...
GIF via [giphy](https://giphy.com/gifs/rickandmorty-season-1-adult-swim-rick-and-morty-fu2rIw18eIDz1YCrCT)2.***“Even if we had the perfect model — no clue of how it will be used within existing workflows”*** This is very common. More often we focus on going from data to insights, but miss out on the last mile from insight to the outcome. Simply predicting customer churn is of little value till is applied to the customer success process to proactively reach out and manage these customers.
